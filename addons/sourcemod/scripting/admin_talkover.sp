...
public void OnPluginStart()
{
	...
	gc_bDefault = CreateConVar("talkover_default", "0", "0 - disabled by default use command to enable, 1 - enabled by default use command to disable", _, true, 0.0, true, 1.0);
	gc_sPrefix = CreateConVar("talkover_prefix", "[TMG-Talk]", "Set your chat prefix for this plugin.");
