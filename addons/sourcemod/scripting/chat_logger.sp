...
public void OnPluginStart()
{
	...
	ConVars[11] = CreateConVar("sm_chat_log_rtf_format", "0", "Format logging (rtf = 1, txt = 0)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	ConVars[12] = CreateConVar("sm_chat_log_console", "1", "Status for console inputs: (1 = on, 0 = off)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	ConVars[13] = CreateConVar("sm_chat_log_folder", "chat_log", "Name of the folder to store chat logs in: (default: chat)", FCVAR_NOTIFY);
