...
#define CMD_PREFIX		"[ToPMiX] " //Prefix in admin activity messages
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_advswap",		CMD_Swap,			ADMFLAG_KICK,		"Swap the targets team");
	RegAdminCmd("sm_advspec",		CMD_Spec,			ADMFLAG_KICK,		"Set the targets team to spectator");
	...
	RegAdminCmd("sm_god",			CMD_God,			ADMFLAG_CONVARS,		"Set godmode for the targets");
	...
	RegAdminCmd("sm_cash",			CMD_Cash,			ADMFLAG_KICK,		"Set the cash for the targets");
	//-----//
